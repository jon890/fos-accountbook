...
export function FamilySelector({ onFamilySelect, onCreateFamily }: FamilySelectorProps) {
    ...
    >
      <div className="max-w-2xl mx-auto px-4">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">가계부 시작하기</h1>
          <p className="text-gray-600">어떤 방식으로 가계부를 관리하시겠어요?</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {families.length > 0 && (
            <>
              <h2 className="text-xl font-semibold text-gray-800 mb-4">기존 가족/그룹</h2>
              {families.map((family) => (
                <Card 
                  key={family.id}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-600">
                          ...
                          <span>
                            지출 {family._count.expenses}건
                          </span>
                          <span>
                            카테고리 {family.categories.length}개
                          </span>
                        </div>
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">혼자 사용하기</h3>
                    <p className="text-gray-600 text-sm">개인 가계부로 시작하기</p>
                  </div>
            ...
            >
              <CardContent className="p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-lg font-semibold text-gray-900 mb-1">새 가족/그룹 만들기</h3>
                    <p className="text-gray-600 text-sm">가족이나 팀과 함께 관리하기</p>
                  </div>
          ...
          {families.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-400 text-sm mt-1">위의 옵션을 선택해서 시작해보세요!</p>
            </div>
          )}
        </div>
      </div>
