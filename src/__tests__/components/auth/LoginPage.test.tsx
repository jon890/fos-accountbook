...
describe('LoginPage Component', () => {
  ...
  it('should render login page with correct title and description', () => {
    ...
    expect(screen.getByText('가족과 함께 관리하는 스마트 가계부')).toBeInTheDocument()
  })

  it('should render Google login button', () => {
    render(<LoginPage />)
    
    const googleButton = screen.getByRole('button', { name: /Google로 시작하기/i })
  ...
  it('should handle sign-in errors gracefully', async () => {
    // Mock signIn to resolve (에러를 실제로 throw하지 않고 호출만 확인)
  ...
  it('should render icons correctly', () => {
    ...
    const walletIcon = document.querySelector('svg[data-testid="wallet-icon"]') || 
